...
//---------------------------------------------------
  ...
  valor=800;             // Valor minimo del pulso
  bajo= valor;
  alto= valor>>8;
  ...
  valor=2220;            // Valor maximo del pulso
  bajo= valor;
  alto= valor>>8;
...
//---------------------------------------------------
  ...
  valor=2135;            // Valor maximo del pulso
  bajo= valor;
  alto= valor>>8;
  EEPROM.write(7, alto);  
  delay(200);
...
//---------------------------------------------------
  ...
  valor=690;            // Valor minimo del pulso
  bajo= valor;
  alto= valor>>8;
  EEPROM.write(9, alto);  
  delay(200);
  ...
  valor=2120;            // Valor maximo del pulso
  bajo= valor;
  alto= valor>>8;
  ...
  valor=600;            // Valor minimo del pulso
  bajo= valor;
  alto= valor>>8;
  ...
  valor=2000;            // Valor maximo del pulso
  bajo= valor;
  alto= valor>>8;
...
//---------------------------------------------------
  ...
  bajo= 180; // Angulo minimo
  alto= 40;   // Angulo maximo
...
//---------------------------------------------------
  ...
  bajo= 130;    // Angulo minimo
  alto= 90;   // Angulo maximo
