...
//****************************************************************************************************************************     
    ...
    #define NUM_MAX_MOVIMIENTOS NUM_MAX_MOVIMIENTOS_1
        /* Triste */       
...
//***************************************************************************************** 
    ...
    #define NUM_MAX_MOVIMIENTOS NUM_MAX_MOVIMIENTOS_2
    /* Sorpresa */
...
//***************************************************************************************** 
#if EXPRESION==3
    #define NUM_MAX_MOVIMIENTOS NUM_MAX_MOVIMIENTOS_3
    /* Disgusto */
...
//***************************************************************************************** 
#if EXPRESION==4
    #define NUM_MAX_MOVIMIENTOS NUM_MAX_MOVIMIENTOS_4
    /* Normal */
...
{
   /* Lectura de sensores 
    capturarDistancia (direccionSFR08_DRCH) ;
...
//******************************************************************************************
void wallETriste(void){

          //Generamos las componentes aleatorias
          //Nueva velocidad
           vel= random(-5,+5);
           
           vel= thisExpDrch[j][1]+vel;
           
           if(vel >100){vel=100;}
           if(vel >100){vel=100;}
           if(vel <0){vel=thisExpDrch[j][1];}
           if(vel <0){vel=thisExpDrch[j][1];}
           ...
           aux= random(0,11);
            ...
            m0Drch= thisExpDrch[j][2] + aux;
            m0Izqd= thisExpIzqd[j][2] + aux;
           ...
           aux= random(0,11);
            ...
            m1Drch= thisExpDrch[j][3] + aux;
            m1Izqd=thisExpIzqd[j][3] + aux;
...
void wallESorpresa(void){
          ...
          //Nuevo movimiento hemisferio
           ...
           cejaIzqd=thisExpIzqd[j][4];
           cejaDrch=thisExpDrch[j][4];
}
//******************************************************************************************
void wallEDisgusto(void){
          ...
          //Nuevo movimiento inclinacion
           ...
           //Nuevo movimiento hemisferio
            m1Drch= thisExpDrch[j][3];
            m1Izqd= thisExpIzqd[j][3];
             
             
             
             
             ceja=cejaIzqd;
             if(thisExpIzqd[j][4]==0){
...
void wallENormal(void){
          ...
          //Nuevo movimiento hemisferio
           ...
           if(thisExpIzqd[j][4]==0 && thisExpDrch[j][4]==0){
                 cejaIzqd= random(1,10);
                 cejaDrch= random(1,10);
